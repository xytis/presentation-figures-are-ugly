...
set terminal pdfcairo enhanced color solid font 'Verdana,10' size 8cm,6cm
set encoding utf8 
...
plot  "data/06" using 1:2 with p ls 1 pt 7 ps 0.5
...
set output '../img/graph_06_no_whiskers.pdf'
plot  "data/06" using 1:2 with p ls 1 pt 7 ps 0.5

set output '../img/graph_06_whiskers.pdf'
plot  "data/06" using 1:2:3 with errorbars ls 1 lw 2 pt 7 ps 0.5
 
set output '../img/graph_06_no_fit.pdf'
plot  "data/06" using 1:2 with lp ls 1 lw 3 pt 7 ps 0.5
